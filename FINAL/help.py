...
┊ ✦ [14] `.ابلاغ` / `.الغاء الابلاغ ` بالرد على  اي رساله وسيتم ارسالها للدعم مباشرة [.ابلاغ 5 مثلا بالرد على الرسالة]
 ...
 **ملاحظة :اذا كنت لاتمتلك الصلاحية لحذف الرسائل سيتم حذف الردشة فقط من طرفك .اما رسائلك فستمسح من الطرفين 
