...
async def help(event):
    ...
    commands = {
        ...
        3: {
            "اسمي": "لوضع اسمك مع ساعة (الأمر مع الاسم الذي تريده).",
            "ايقاف اسمي": "لعودة اسمك الى وضعه السابق."
        },
        2: {
        ...
        7: {
            "ابلاغ": "بالرد على  اي رساله وسيتم ارسالها للدعم مباشرة [.ابلاغ 5 مثلا بالرد على الرسالة]",
            "الغاء الابلاغ": "لإلغاء الابلاغ عن الرسائل."
        },
        10: {
