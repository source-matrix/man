...
@events.register(events.NewMessage(outgoing=True, pattern=r"^\.مقاتل( (.*)|$)"))
async def kiler(ult):
...
@events.register(events.NewMessage(outgoing=True, pattern=r"^\.raped( (.*)|$)"))
async def raped(ult):
    ult = await ult.edit("...")
    animation_interval = 1
...
@events.register(events.NewMessage(outgoing=True, pattern=r"^\.hands( (.*)|$)"))
async def hands(ult):
    ult = await ult.edit("...")
    animation_interval = 1
...
@events.register(events.NewMessage(outgoing=True, pattern=r"^\.count( (.*)|$)"))
async def count(ult):
    ult = await ult.edit("...")
    animation_interval = 1
...
@events.register(events.NewMessage(outgoing=True, pattern=r"^\.bigoof$"))
